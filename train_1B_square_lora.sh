...
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch train_1B_square_lora.py \
  ...
  --validation_reference_path="llmy-square/lmy_f0009/00002/images/frame_0.png" \
  --validation_driven_audio_path="lmy-square/lmy_f0009/00002/audio.wav" \
  --train_data_square_dir="lmy-square/lmy_square_f0009.txt" \
  ...
  --lr_warmup_steps=100 \
  --seed=42 \
  --output_dir="checkpoints/lmy_f0009_10mins_lora" \
