...
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch train_1B_square.py \
  ...
  --validation_reference_path="lmy_white_72mins/square/speech/00002/images/frame_0.png" \
  --validation_driven_audio_path="lmy_white_72mins/square/speech/00002/vocal.wav" \
  --train_data_square_dir="lmy_white_72mins/lmy_white_72mins.txt"  \
  ...
  --lr_warmup_steps=100 \
  --seed=42 \
  --output_dir="checkpoints/lmy_white_72mins" \
